...
<!-- header_eof //-->
<!-- body //-->
<table border="0" width="100%" cellspacing="2" cellpadding="2" style="padding: 10px;">
  <tr>
<!-- body_text //-->
...
<?php } ?>
          <tr>
            <td class="main" align="right" valign="middle">
              <?php
                if ($show_products_type_layout == 'false' and ($check_configure->fields['configuration_id'] != 0 and $check_configure->fields['configuration_group_id'] != 6)) {
                  ...
                  if ($show_products_type_layout == 'true') {
                    echo '<a class="aButton" href="' . zen_href_link(FILENAME_PRODUCT_TYPES) . '">Edit</a>';
                  } else {
                    if ($page != '') {
                      echo '<a class="aButton" href="' . zen_href_link(FILENAME_MODULES, 'set=' . $page) . '">Edit</a>';
                    } else {
            ...
            <td class="main" align="center" valign="middle"><?php echo '<a class="aButton" href="' . zen_href_link(FILENAME_STORE_MANAGER) . '">Reset</a>'; ?></td>
          </tr>
        </table>
      </td></tr>
<?php
      ...
      <tr>
        <td colspan="2"><br /><table border="0" cellspacing="0" cellpadding="2">
          <tr>
            ...
            <td class="main" align="right" valign="middle"><?php echo '<a class="aButton" href="' . zen_href_link(FILENAME_STORE_MANAGER, 'action=clean_admin_activity_log') . '">Reset</a>'; ?></td>
          </tr>
        </table></td>
      </tr>
      ...
      <tr>
        <td colspan="2"><br /><table border="0" cellspacing="0" cellpadding="2">
          <tr>
            ...
            <td class="main" align="right" valign="middle"><?php echo '<a class="aButton" href="' . zen_href_link(FILENAME_STORE_MANAGER, 'action=update_all_products_attributes_sort_order') . '">Update</a>'; ?></td>
          </tr>
        </table></td>
      </tr>
      ...
      <tr>
        <td colspan="2"><br /><table border="0" cellspacing="0" cellpadding="2">
          <tr>
            ...
            <td class="main" align="right" valign="middle"><?php echo '<a class="aButton" href="' . zen_href_link(FILENAME_STORE_MANAGER, 'action=update_all_products_price_sorter') . '">Update</a>'; ?></td>
          </tr>
        </table></td>
      </tr>
      ...
      <tr>
        <td colspan="2"><br /><table border="0" cellspacing="0" cellpadding="2">
          <tr><form name = "update_counter" action="<?php echo zen_href_link(FILENAME_STORE_MANAGER, 'action=update_counter', 'NONSSL'); ?>" method="post">
            ...
            <td class="main" align="right" valign="middle">
							<input class="aButton" type="submit" value="Reset" />
						</td>
          </form></tr>
        </table></td>
      </tr>
      ...
      <tr>
        <td colspan="2"><br /><table border="0" cellspacing="0" cellpadding="2">
          <tr>
            ...
            <td class="main" align="right" valign="middle"><?php echo '<a class="aButton" href="' . zen_href_link(FILENAME_STORE_MANAGER, 'action=update_all_products_viewed') . '">Reset</a>'; ?></td>
          </tr>
        </table></td>
      </tr>
      ...
      <tr>
        <td colspan="2"><br /><table border="0" cellspacing="0" cellpadding="2">
          <tr>
            ...
            <td class="main" align="right" valign="middle"><?php echo '<a class="aButton" href="' . zen_href_link(FILENAME_STORE_MANAGER, 'action=update_all_products_ordered') . '">Reset</a>'; ?></td>
          </tr>
        </table></td>
      </tr>
      ...
      <tr>
        <td colspan="2"><br /><table border="0" cellspacing="0" cellpadding="2">
          <tr>
            ...
            <td class="main" align="right" valign="middle"><?php echo '<a class="aButton" href="' . zen_href_link(FILENAME_STORE_MANAGER, 'action=update_all_master_categories_id') . '">Reset</a>'; ?></td>
          </tr>
        </table></td>
      </tr>
        ...
        <td colspan="2"><br /><table border="0" cellspacing="0" cellpadding="2">
          <tr><form name = "update_orders" action="<?php echo zen_href_link(FILENAME_STORE_MANAGER, 'action=update_orders_id', 'NONSSL'); ?>" method="post">
            <td class="main" align="left" valign="top">
							<?php echo TEXT_ORDERS_ID_UPDATE; ?>
						</td>
            <td class="main" align="left" valign="bottom">
              <div><?php echo TEXT_OLD_ORDERS_ID . '&nbsp;&nbsp;' . zen_draw_input_field('old_orders_id'); ?></div>
              <div style="margin-top: 16px;"><?php echo TEXT_NEW_ORDERS_ID . '&nbsp;' . zen_draw_input_field('new_orders_id'); ?></div>
            </td>
            <td class="main" align="right" valign="middle">
							<input class="aButton" type="submit" value="Reset" />
						</td>
        ...
        <td colspan="2"><br /><table border="0" cellspacing="0" cellpadding="2">
          ...
          <tr><form name = "locate_configure_key" action="<?php echo zen_href_link(FILENAME_STORE_MANAGER, 'action=locate_configuration_key', 'NONSSL'); ?>" method="post">
            ...
            <td class="main" align="center" valign="bottom">
							<input class="aButton" type="submit" value="Search" />
						</td>
      ...
      <tr>
        <td colspan="2"><br /><br /><table border="0" cellspacing="0" cellpadding="2">
          <tr>
            ...
            <td class="main" align="right" valign="middle"><?php echo '<a class="aButton" href="' . zen_href_link(FILENAME_STORE_MANAGER, 'action=optimize_db') . '">Confirm</a>'; ?></td>
          </tr>
        </table></td>
      </tr>
