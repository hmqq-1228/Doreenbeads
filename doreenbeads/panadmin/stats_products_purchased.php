...
// Thus this older query is somewhat deprecated
  $products_query_raw = "select p.products_id, p.products_image, p.products_quantity, p.products_model, p.products_status,  p.products_ordered, pd.products_name from " . TABLE_PRODUCTS . " p, " . TABLE_PRODUCTS_DESCRIPTION . " pd where pd.products_id = p.products_id and pd.language_id = '" . $_SESSION['languages_id']. "' and p.products_ordered > 0 group by pd.products_id order by p.products_ordered DESC, pd.products_name";
...
?>
              <tr class="dataTableRow" onMouseOver="rowOverEffect(this)" onMouseOut="rowOutEffect(this)">
                <td class="dataTableContent" align="left"><?php echo '<a href="' . zen_href_link(FILENAME_STATS_PRODUCTS_PURCHASED, zen_get_all_get_params(array('oID', 'action', 'page', 'products_filter')) . 'products_filter=' . $products->fields['products_id']) . '">' . $products->fields['products_id'] . '</a>'; ?>&nbsp;&nbsp;</td>
				<td align="center" class="dataTableContent"><?php echo $products->fields['products_model'];?></td>
                ...
                <td class="dataTableContent"><?php echo '<a href="' . zen_href_link('../index.php?main_page=' . FILENAME_PRODUCT_INFO . '&products_id=' . $products->fields['products_id']) . '" target="_blank">' . $products->fields['products_name'] . '</a>'; ?></td>
