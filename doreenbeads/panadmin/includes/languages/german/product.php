...
define('TEXT_MOVE_SELECTED','Move Selected');
define('TEXT_DISABLE_SELECTED','Disable/Enable Selected');
define('TEXT_COPY_SELECTED','Copy Selected');
...
//jessa 2009-08-24 ����products_net_price�����Ķ���
define('TEXT_PRODUCTS_NET_PRICE','Products Net Price');
...
// Products and Discount Copy Options
  ...
  define('LIMIT_STOCK_QUANTITY','limit the stock quantity:');
  ...
  define('TEXT_PRODUCTS_LIMIT_STOCK_EDIT','*product is marked as LIMIT STOCK');
...
// meta tags
  ...
  define('TEXT_INFO_HEADING_DISABLE_PRODUCT', 'Disable/Enable Products');

  define('TEXT_DISABLE_PRODUCTS_INTRO', '<b>Are you sure you want to change the status of these products?<br/>%s</b>');
  
  define('TEXT_DISABLE_SELECTED','Disable/Enable Selected');
  
  define('TEXT_CATEGORIES_PROD_CHANGE_WARNING', ', parent category is disabled!');
