...
define('AVATAR_CHECK_ADDRESS','service_de@doreenbeads.com');
...
// include additional files:
  ...
  define('TEXT_IN_ORDER_TO_THANKS_FOR_YOU', 'Afin de vous remercier pour votre première commande chez nous, nous vous avons envoyé 2 coupons sur votre compte. <a href="' . HTTP_SERVER .'/fr/index.php?main_page=my_coupon' . '" target="_blank">Voir mon coupon >></a>');
