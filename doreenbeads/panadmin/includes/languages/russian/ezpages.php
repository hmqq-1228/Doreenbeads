...
//jessa 2010-01-17
define('TEXT_IS_NEWS', 'News Type: ');
define('TEXT_STATUS_NEWS_HEADER', 'Status News Header: ');
define('TEXT_NEWS_SORTER', 'News Sorter: ');
define('TABLE_HEADING_IS_NEWS', 'News Type:');
define('TABLE_HEADING_IS_HEADER', 'News Header:');
define('TEXT_FILTER_BY_HEADER', 'Filter By Header');
define('TEXT_FILTER_BY_SIDEBOX', 'Filter By Sidebox');
define('TEXT_FILTER_BY_FOOTER', 'Filter By Footer');
define('TEXT_FILTER_BY_NEWS', 'Filter By News');
define('TEXT_FILTER_BY_HEADER_NEWS', 'Filter By Header News');
