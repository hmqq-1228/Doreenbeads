...
define('AVATAR_CHECK_ADDRESS','service_ru@doreenbeads.com');
...
// include additional files:
  ...
  define('TEXT_IN_ORDER_TO_THANKS_FOR_YOU', 'Vielen Dank für Ihre erste Bestellung bei uns. Wir haben Ihnen 2 Gutscheine auf Ihr Konto gesendet. <a href="' . HTTP_SERVER .'/de/index.php?main_page=my_coupon' . '" target="_blank">Gutschein Anzeigen>></a>');
