...
define('NAVBAR_TITLE', 'Add Shipping Address');
define('NAVBAR_TITLE_1', 'Checkout');
define('NAVBAR_TITLE_2', 'Add Shipping Address');

//jessa 2010-02-24 update
define('HEADING_TITLE', 'Add New Address');
//eof jessa 2010-02-24

define('TABLE_HEADING_SHIPPING_ADDRESS', 'Shipping Address');
define('TABLE_HEADING_ADDRESS_LINE','Address Line');
...
define('TITLE_PLEASE_SELECT', 'Create A New Shipping Address');
