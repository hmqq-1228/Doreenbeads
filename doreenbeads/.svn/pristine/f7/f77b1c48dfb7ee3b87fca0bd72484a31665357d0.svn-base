...
define ( 'DIR_WS_LANGUAGE_IMAGES', DIR_WS_TEMPLATE . 'images/' . $_SESSION ['language'] . '/' );
define ( 'DIR_WS_USER_AVATAR', DIR_WS_IMAGES . 'Users/' );
define ( 'DIR_WS_TEMPLATE_TPL', DIR_WS_TEMPLATE . 'tpl/' );
/**
 * The actual template icons directory to use
 */
define ( 'DIR_WS_TEMPLATE_ICONS', DIR_WS_TEMPLATE_IMAGES . 'icons/' );
define ( 'DIR_WS_LANGUAGE_ICONS', DIR_WS_TEMPLATE_IMAGES . 'icons/' . $_SESSION ['language'] . '/' );
...
/**
 * include the template language master (to catch all items not defined in the
 * override file).
 * The intent here is to: load the override version to catch preferencial
 * changes;
 * then load the original/master version to catch any defines that didn't get
 * set into the override version during upgrades, etc.
 */
// THE FOLLOWING MIGHT NEED TO BE DISABLED DUE TO THE EXISTENCE OF function()
// DECLARATIONS IN MASTER ENGLISH.PHP FILE
// THE FOLLOWING MAY ALSO SEND NUMEROUS ERRORS IF YOU HAVE ERROR_REPORTING
// ENABLED, DUE TO REPETITION OF SEVERAL DEFINE STATEMENTS
//include_once (DIR_WS_LANGUAGES . $_SESSION ['language'] . '.php');
