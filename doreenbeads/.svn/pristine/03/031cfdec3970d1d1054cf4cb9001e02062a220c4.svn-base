 ...
 */
  ...
  if (zen_not_null($action)) {
    switch ($action) {
    	//bof zale
    	case 'add_method_step1_process' :
    	case 'add_method_step2_process' :
    	case 'add_method_step3_process' :
    	case 'add_method_step2' :
    	case 'add_method_step3' :
    	case 'install_finaly_confirm' :
    	case 'delete_method' :
    		require(DIR_WS_MODULES . 'install_new_method.php'); break;
    	case 'cancel' :
    		unset($_SESSION['method_code']);
    		break;
    	//eof    	   
