...
<!--bof Form start-->
<?php echo zen_draw_form('cart_quantity', zen_href_link('product_info', zen_get_all_get_params(array('action')) . 'action=add_product'), 'post', 'enctype="multipart/form-data"') . "\n"; ?>
<!--eof Form start-->
