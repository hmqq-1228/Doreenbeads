...
<div id="productListing" class="pagelistlinks">
 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td  align="right" style="padding:5px 0px; border-bottom:1px solid #CCCCCC;">
		<?php echo TEXT_RESULT_PAGE . ' ' . $listing_split->display_links(MAX_DISPLAY_PAGE_LINKS, zen_get_all_get_params(array('page', 'info', 'main_page'))); ?>
  ...
  <tr>  
  	<td colspan="2">
		<table width="100%"><tr>
			...
			<td align="right"><?php //echo $listing_split->display_jump_page(0, zen_get_all_get_params(array('page', 'info', 'main_page')));?>	
			</td>
		</tr></table>
	</td>
  </tr>
...
?>
<div style="clear:both;" class="pagelistlinks">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
  ...
  <tr>  
  	...
  	<td width="50%" align="right" style="padding:5px 0px; border-bottom:1px solid #CCCCCC;"><?php //echo $listing_split->display_jump_page(1, zen_get_all_get_params(array('page', 'info', 'main_page')));?>	</td>
  </tr>
--></table>
</div>
<!--
