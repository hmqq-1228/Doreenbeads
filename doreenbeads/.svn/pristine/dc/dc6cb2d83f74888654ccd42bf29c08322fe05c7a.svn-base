...
define('SUB_TITLE_REVIEW', 'Please tell us what you think about this product and share your opinions with others.');
define('SUB_TITLE_RATING', 'Choose a ranking for this item. 1 star is the worst and 5 stars is the best.');

define('TEXT_NO_HTML', '<b>Please Note: </b><br />**HTML tags are not allowed.');
define('TEXT_BAD', 'Worst');
define('TEXT_GOOD', 'Best');
define('TEXT_PRODUCT_INFO', '');
//jessa 2009-10-25 add 'While reviews require prior aprroval before they will be displayed' 修改产品 的write views 的提示内容
