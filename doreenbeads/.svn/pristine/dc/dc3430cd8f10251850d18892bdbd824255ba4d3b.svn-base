...
define('AVATAR_CHECK_ADDRESS','service_fr@doreenbeads.com');
...
define('BOX_TOOLS_DEFINE_PRODUCT_UPDATER','Product Updater for 8Season');
...
// include additional files:
  ...
  define('TEXT_IN_ORDER_TO_THANKS_FOR_YOU', 'Чтобы поблагодарить вас за первый заказ с нами, мы отправили вам 2 купона на ваш счет. <a href="' . HTTP_SERVER .'/ru/index.php?main_page=my_coupon' . '" target="_blank">Просмотреть Мой Купон >></a>');
