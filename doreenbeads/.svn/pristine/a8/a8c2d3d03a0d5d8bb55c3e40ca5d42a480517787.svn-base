...
define('BOX_HEADING_AFFILIATE', 'Affiliate');
define('BOX_AFFILIATE_COMMISSION', '佣金管理');
define('BOX_AFFILIATE_COMMISSION_INFO', '佣金明細');
...
//jessa 2010-02-26 ����matching prodcuts manager�ĵ����������ֶ���
define('BOX_CATALOG_MATCH_PRODUCTS', 'Macth products manager');
...
//jessa 2009-12-28 ���ӹ˿����չ���ĳ�������
define('BOX_CUSTOMERS_BIRTHDAY', 'Birthday Manager');
...
define('BOX_TOOLS_DEFINE_PRODUCT_UPDATER','Product Updater for Doreenbeads');
define('BOX_TOOLS_DEFINE_POSTAGE_MANAGE','Postage Discount Manage');
...
define('TEXT_DISPLAY_NUMBER_OF_ROLES', 'Displaying <b>%d</b> to <b>%d</b> (of <b>%d</b> roles)');
...
define('TEXT_DISPLAY_NUMBER_OF_SHIPPING_METHODS', 'Displaying <b>%d</b> to <b>%d</b> (of <b>%d</b> shipping methods)');
define('TEXT_DISPLAY_NUMBER_OF_RESULTS', '当前展示  <b>%d</b> - <b>%d</b> (共  <b>%d</b> 条记录)');
define('TEXT_DISPLAY_NUMBER_OF_TESTIMONIAL', 'Displaying <b>%d</b> to <b>%d</b> (of <b>%d</b> testimonials)');
//eof jessa 2010-06-17
...
define('BOX_CATALOG_CLEARANCE_PRODUCTS','Clearance Show Products');
...
define('TEXT_PRODUCT_WEIGHT_UNIT','gram');
//eof jessa
...
// admin activity log warnings
  ...
  define(TEXT_SEARCH_FORMAT, 'Model Format: B00001,B00002...');
///////////////////////////////////////////////////////////
// include additional files:
  ...
  define('TEXT_IN_ORDER_TO_THANKS_FOR_YOU', 'In order to thanks for your first order with us, we have sent you 2 coupons to your account. <a href="' . HTTP_SERVER .'/index.php?main_page=my_coupon' . '" target="_blank">View My Coupon >></a>');
