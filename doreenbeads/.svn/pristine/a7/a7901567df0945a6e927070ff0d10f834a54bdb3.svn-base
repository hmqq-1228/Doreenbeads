...
define('SITE_TAGLINE', 'Pandora Style Beads Charms Spacer Clip Chain and other Supplies Wholesale');
//eof jessa

// Custom Keywords
//jessa 2009-08-07 Update the CUSTOM_KEYWORDS on on meta_tags.php page "ecommerce, open source, shop, online shopping"
define('CUSTOM_KEYWORDS', 'pandora style beads wholesale, pandora style charms wholesale,pandora chain wholesale,Pandora free shipping,Pandora Supplies Wholesale');
//eof jessa

// Home Page Only:
//jessa 2009-08-09
//update define('HOME_PAGE_META_DESCRIPTION', '')
  define('HOME_PAGE_META_DESCRIPTION', 'We offer Free Shipping for all our items and mainly wholesale pandora style beads charms,snake chain bracelet and other supplies(including safety chain, pandora lampwork glass beads,pandora charms, clip, spacer beads).');
//eof jessa
//update define('HOME_PAGE_META_KEYWORDS','')
  define('HOME_PAGE_META_KEYWORDS', 'pandora style beads wholesale, pandora style charms wholesale,pandora chain wholesale,Pandora free shipping,Pandora Supplies Wholesale');
//eof jessa
