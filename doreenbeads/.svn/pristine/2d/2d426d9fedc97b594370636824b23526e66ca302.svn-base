 ...
 * By default it is automatically set but you can also set it as a fixed string to improve performances.
 */
define ('K_PATH_IMAGES', DIR_WS_TEMPLATE_IMAGES);
/**
 * Deafult image logo used be the default Header() method.
 * Please set here your own logo or an empty string to disable it.
 */
define ('PDF_HEADER_LOGO', 'news_logo.png');
 ...
 * Document creator.
 */
define ('PDF_CREATOR', '8seasons');

/**
 * Document author.
 */
define ('PDF_AUTHOR', '8seasons');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', '8seasons');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', STORE_NAME_ADDRESS);
