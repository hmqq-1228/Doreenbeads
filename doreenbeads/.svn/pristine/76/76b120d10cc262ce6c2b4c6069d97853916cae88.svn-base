...
define('EMAIL_TEXT_SUBJECT', 'Your Link Add Successfully');
define('EMAIL_GREET_NONE', 'Dear %s ,' . "\n\n");
define('EMAIL_TEXT', 'The status of your link at ' . STORE_NAME . ' has been added <font color="#e6172c"><strong>successfully</strong></font>.' . "\n\n".'<br/><br/>The information of your link on our site:');
define('EMAIL_TEXT_NEW_STATUS', 'The New Status is: %s' ."\n\n");
define('EMAIL_TEXT_REPLY', 'Please keep it in mind that in order to keep your link on our site for a long time, please keep our link alive on your site in return. We\'ll check the link regularly. 
		If we don\'t find our link, your link will be removed instead.<br/><br/>If you have any other questions, please feel free to contact us.' . "\n\n");
define('EMAIL_TEXT_STATUS_UPDATE', 'Dear %s,<br />The status of your link at ' . STORE_NAME . ' has been updated.<br />New status: %s<br />Please reply to this email if you have any questions.<br />');
define('EMAIL_TEXT_CHECK_URL','You can check this URL to find your link:');
