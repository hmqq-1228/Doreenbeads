 ...
 */
  if ($configuration->fields['cfgvalue'] == 'notification@doreenbeads.com'){
	$notification_email_array[strtoupper($configuration->fields['cfgkey'])] = $configuration->fields['cfgvalue'];			
  }else{
...
//define('SHOW_PROMOTION_AREA_START_TIME', '2014-03-27 14:00:00');
//define('SHOW_PROMOTION_AREA_END_TIME', '2014-04-04 16:00:00');

define('SHOW_PROMOTION_AREA_STATUS', 1);
?>