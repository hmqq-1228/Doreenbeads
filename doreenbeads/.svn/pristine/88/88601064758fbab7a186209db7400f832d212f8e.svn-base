...
var jsonImages = [["<?php echo addslashes(zen_image($products_image_medium, '', '380'));?>","<?php echo addslashes($products_name);?>"],["<?php echo addslashes(zen_image($products_image_01, '', '380'));?>","<?php echo addslashes($products_name);?>"],["<?php echo addslashes(zen_image($products_image_02, '', '380'));?>","<?php echo addslashes($products_name);?>"]];
var noImg = 0;
