...
function set_phplive(){
	var srcCode = '<script language="JavaScript"  src="https://livechat.doreenbeads.com/dblivehelp/js/status_image.php?langs=<?php echo $_SESSION["language"]?>&uname=<?php echo $_SESSION['customer_first_name'];?>&uemail=<?php echo $url_email;?>&base_url=http://72.14.190.244/dblivehelp&l=Doreenbeads.com&x=1&deptid=1&"><\/script>';
