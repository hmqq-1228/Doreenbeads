...
<div class="pop_facebook" id="pop_fblike">
	...
	<h4>Как нам на Facebook</h4>
    <p>чтобы получить бесплатный комплект образцов!</p>
    <div class="btn_like"></div>
	<span class="fb-like" data-href="https://www.facebook.com/doreenbeads" data-layout="button" data-action="like" data-show-faces="false" data-share="false" style="position: absolute;left: 283px;top: 170px;"></span>
</div>