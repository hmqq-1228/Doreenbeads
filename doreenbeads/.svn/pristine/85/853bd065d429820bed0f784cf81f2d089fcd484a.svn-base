...
if (isset($_GET['addr_edit']) && $_GET['addr_edit'] == 'edit'){
	$hidden_field_value = $_GET['addr_edit'];
}
...
if (isset($_POST['action']) && (($_POST['action'] == 'process') || ($_POST['action'] == 'update'))) {
  ...
  if ($error == false) {
    $sql_data_array= array(array('fieldName'=>'entry_firstname', 'value'=>$firstname, 'type'=>'string'),
                           ...
                           array('fieldName'=>'telephone_number', 'value'=>$telephone, 'type'=>'string'),
	...
	//jessa 2010-02-08 �������ж��û��޸ĵ�ַ��ʱ���Ƿ��checkout�����ģ��������Ҫ����checkoutҳ�棬���򷵻�address bookҳ��
...
if (isset($_GET['edit']) && is_numeric($_GET['edit'])) {
  $entry_query = "SELECT entry_gender, entry_company, entry_firstname, entry_lastname,
                         ...
                         entry_state, entry_zone_id, entry_country_id, telephone_number, customers_telephone 
