...
define('TEXT_PRODUCT_FREE_SHIPPING_ICON', zen_image(DIR_WS_LANGUAGE_IMAGES . 'always-free-shipping.gif', 'Always Free Shipping')); // for an image or comment out to use another
?>