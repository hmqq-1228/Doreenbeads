 ...
 */
  ...
  if (isset($_GET['order_id'])) $_GET['order_id'] = ereg_replace('[^0-9a-f:]', '', $_GET['order_id']);
/**
 ...
 */
  ...
  if ((!is_dir(DIR_WS_MODULES .  'pages/' . $_GET['main_page'])&&!$is_mobilesite) || (!file_exists(DIR_WS_MODULES .'mobilesite/'. $_GET['main_page'].'.php')&&$is_mobilesite)) {
  ...
  if ($is_mobilesite) {
  	$code_page_directory = DIR_WS_MODULES . 'mobilesite/';
  }else{
