...
define('TEXT_APPROVAL_REQUIRED', '<strong>NOTE:</strong>  Your reviews have been submitted successfully. While reviews require prior aprroval before they will be displayed');
