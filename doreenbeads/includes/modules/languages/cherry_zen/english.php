...
//jessa 2009-08-09
/*delete "FOOTER_TEXT_BODY', 'Template designed by <a href="http://www.sagefish.com/" target="_blank">Sage Fish.com</a>.&nbsp;"*/
/*
ԭ���Ĵ����ǣ�define('FOOTER_TEXT_BODY', 'Template designed by <a href="http://www.sagefish.com/" target="_blank">Sage Fish.com</a>.&nbsp;Copyright &copy; ' . date('Y') . ' <a href="' . zen_href_link(FILENAME_DEFAULT) . '" target="_blank">' . STORE_NAME . '</a>. Powered by <a href="http://www.zen-cart.com" target="_blank">Zen Cart</a>');
*/
  define('Copyright &copy; ' . date('Y') . ' <a href="' . zen_href_link(FILENAME_DEFAULT) . '" target="_blank">' . STORE_NAME . '</a>. Powered by <a href="http://www.zen-cart.com" target="_blank">Zen Cart</a>');
//eof jessa
...
//jessa 2009-09-11 update the code "<span class="successspan">[&nbsp<a href="index.php?main_page=shopping_cart" style="color:#0000FF">Shopping cart</a>&nbsp]&nbsp;&nbsp;[&nbsp<a href="index.php?main_page=checkout_shipping" style="color:#0000FF">Checkout</a>&nbsp]</span>"
//jessa 2009-10-25 �޸�����ӵ�����Ʒ�ɹ�����ֵ�[shipping cart]��[checkout]����ʽ
  define('SUCCESS_ADDED_TO_CART_PRODUCT', 'Successfully added Product to the cart ...&nbsp;<a href="index.php?main_page=shopping_cart" style="color:#FF0000">[Shopping cart]</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="index.php?main_page=checkout_shipping" style="color:#FF0000">[Checkout]</a>&nbsp;');
//eof jessa 2009-09-11
// only for where multiple add to cart is used:
  define('SUCCESS_ADDED_TO_CART_PRODUCTS', 'Successfully added selected Product(s) to the cart ...&nbsp;<a href="index.php?main_page=shopping_cart" style="color:#0000FF">[Shopping cart]</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="index.php?main_page=checkout_shipping" style="color:#FF0000">[Checkout]</a>&nbsp;');
//eof jessa 2009-10-25
//jessa 2009-08-11
//update define('TEXT_PRODUCT_WEIGHT_UNIT','lbs')
