  ...
  class ot_shipping {
    ...
    function ot_shipping() {
  	...
  	function get_shipping_cost(){
    	global $order;
    	return $order->info['shipping_cost'];
    }
    ...
    function process() {
      ...
      $order->info['total'] += $order->info['shipping_cost'];
        $this->output[] = array('title' => $order->info['shipping_method'] . ':',
                                'text' => $order->info['shipping_cost'] == 0 ? TEXT_FREE_SHIPPING : $currencies->format($order->info['shipping_cost'], true, $order->info['currency'], $order->info['currency_value']),
