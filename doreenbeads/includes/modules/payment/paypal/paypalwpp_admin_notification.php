 ...
 */
  ...
  if ($response['RESPMSG'] != '') {
    ...
    $outputPayPal .= '</td><td class="main">'."\n";
    $outputPayPal .= ($_SESSION['show_customer_email'] ? urldecode($ipn->fields['payer_email']) : strstr($ipn->fields['payer_email'], '@', true) . '@') ."\n";
    $outputPayPal .= '</td></tr>'."\n";
    ...
    $outputPayPal .= '</td><td class="main">'."\n";
    $outputPayPal .= urldecode($ipn->fields['payer_id']) ."\n";
    $outputPayPal .= '</td></tr>'."\n";

    $outputPayPal .= '<tr><td class="main">'."\n";
    $outputPayPal .= MODULE_PAYMENT_PAYPAL_ENTRY_PAYER_STATUS."\n";
    $outputPayPal .= '</td><td class="main">'."\n";
    $outputPayPal .= urldecode($ipn->fields['payer_status']) ."\n";
    $outputPayPal .= '</td></tr>'."\n";

    $outputPayPal .= '<tr><td class="main">'."\n";
    $outputPayPal .= MODULE_PAYMENT_PAYPAL_ENTRY_ADDRESS_STATUS."\n";
    $outputPayPal .= '</td><td class="main">'."\n";
    $outputPayPal .= urldecode($ipn->fields['address_status']) ."\n";
    $outputPayPal .= '</td></tr>'."\n";

    $outputPayPal .= '<tr><td class="main">'."\n";
    $outputPayPal .= MODULE_PAYMENT_PAYPAL_ENTRY_TXN_TYPE."\n";
    $outputPayPal .= '</td><td class="main">'."\n";
    $outputPayPal .= urldecode($ipn->fields['txn_type']) ."\n";
    $outputPayPal .= '</td></tr>'."\n";

    $outputPayPal .= '<tr><td class="main">'."\n";
    $outputPayPal .= MODULE_PAYMENT_PAYPAL_ENTRY_TXN_ID."\n";
    $outputPayPal .= '</td><td class="main">'."\n";
    $outputPayPal .= urldecode($ipn->fields['txn_id']) ."\n";
    $outputPayPal .= '</td></tr>'."\n";

    $outputPayPal .= '<tr><td class="main">'."\n";
    $outputPayPal .= MODULE_PAYMENT_PAYPAL_ENTRY_PARENT_TXN_ID."\n";
    $outputPayPal .= '</td><td class="main">'."\n";
    $outputPayPal .= urldecode($ipn->fields['parent_txn_id']) ."\n";
    $outputPayPal .= '</td></tr>'."\n";
    ...
    $outputPayPal .= '</td><td class="main">'."\n";
    $outputPayPal .= urldecode($ipn->fields['payment_type']) ."\n";
    $outputPayPal .= '</td></tr>'."\n";
    
    $outputPayPal .= '<tr><td class="main">'."\n";
    $outputPayPal .= MODULE_PAYMENT_PAYPAL_ENTRY_PAYMENT_STATUS."\n";
    $outputPayPal .= '</td><td class="main">'."\n";
    $outputPayPal .= urldecode($ipn->fields['payment_status']) ."\n";
    $outputPayPal .= '</td></tr>'."\n";
    
    $outputPayPal .= '<tr><td class="main">'."\n";
    $outputPayPal .= MODULE_PAYMENT_PAYPAL_ENTRY_PENDING_REASON."\n";
    $outputPayPal .= '</td><td class="main">'."\n";
    $outputPayPal .= urldecode($ipn->fields['reason_code']) . ($ipn->fields['reason_code'] == 'None' ? '' : urldecode($ipn->fields['reason_code'])) ."\n";
    $outputPayPal .= '</td></tr>'."\n";
    ...
    $outputPayPal .= '</td><td class="main">'."\n";
    $outputPayPal .= urldecode($ipn->fields['payment_date']) ."\n";
    $outputPayPal .= '</td></tr>'."\n";
    ...
    $outputPayPal .= '</td><td class="main">'."\n";
    $outputPayPal .= urldecode($ipn->fields['mc_gross']) ."\n";
    $outputPayPal .= '</td></tr>'."\n";
    
    $outputPayPal .= '<tr><td class="main">'."\n";
    $outputPayPal .= MODULE_PAYMENT_PAYPAL_ENTRY_PAYMENT_FEE."\n";
    $outputPayPal .= '</td><td class="main">'."\n";
    $outputPayPal .= urldecode($ipn->fields['payment_fee']) ."\n";
    $outputPayPal .= '</td></tr>'."\n";

    $outputPayPal .= '<tr><td class="main">'."\n";
    $outputPayPal .= MODULE_PAYMENT_PAYPAL_ENTRY_EXCHANGE_RATE."\n";
    $outputPayPal .= '</td><td class="main">'."\n";
    $outputPayPal .= urldecode($ipn->fields['exchange_rate']) ."\n";
    $outputPayPal .= '</td></tr>'."\n";
