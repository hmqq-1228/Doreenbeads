...
/*
fetal time out error  time older than 30 seconds
robbie wei 08-12-1
*/
set_time_limit(600);
//end
...
if (isset($_POST['payment'])) $_SESSION['payment'] = $payment;
...
if($_POST['payment'] == 'paypalwpp'){
   zen_redirect('ipn_main_handler.php?type=ec&markflow=1&clearSess=1&stage=final', '', 'SSL');exit;
}
...
//	order created, redirect to process
