...
if ((isset($_POST['action'])) && ($_POST['action'] == 'shipping_fee')){
	if (isset($_POST['select_address']) && $_POST['select_address'] != ''){
		$_SESSION['sendto'] = $_POST['select_address'];
		$_SESSION['reset_shipping_fee'] = 'true';
	}else{
		$_SESSION['reset_shipping_fee'] = 'false';
		$_SESSION['address_select_error'] = TEXT_CHOOSE_SHIPPING_ADDRESS;
	}
