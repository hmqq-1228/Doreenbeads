...
// TCPDF configuration
require_once(DIR_FS_CATALOG . DIR_WS_CLASSES . 'pdf/tcpdf_config_alt.php');
require_once(DIR_FS_CATALOG . DIR_WS_CLASSES . 'pdf/tcpdf_autoconfig.php');
// TCPDF static font methods and data
require_once(DIR_FS_CATALOG . DIR_WS_CLASSES . 'pdf/tcpdf_font_data.php');
// TCPDF static font methods and data
require_once(DIR_FS_CATALOG . DIR_WS_CLASSES . 'pdf/tcpdf_fonts.php');
// TCPDF static color methods and data
require_once(DIR_FS_CATALOG . DIR_WS_CLASSES . 'pdf/tcpdf_colors.php');
// TCPDF static image methods and data
require_once(DIR_FS_CATALOG . DIR_WS_CLASSES . 'pdf/tcpdf_images.php');
// TCPDF static methods and data
require_once(DIR_FS_CATALOG . DIR_WS_CLASSES . 'pdf/tcpdf_static.php');
