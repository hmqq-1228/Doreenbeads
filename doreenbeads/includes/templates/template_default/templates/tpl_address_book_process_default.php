...
<?php
	//jessa 2010-02-09 ��checkout��һ�����ݹ����Ĳ�����ܹ������ŵ��?�У��ύ��updateҳ�棬�����ж��û����������update��ַ��
	echo '<input type="hidden" name="address_checkout" value="' . $hidden_field_value . '">';
...
<div class="buttonRow back">
	<?php 
		if (isset($_GET['addr_edit']) && $_GET['addr_edit'] == 'edit'){
			echo '<a href="' . zen_href_link(FILENAME_CHECKOUT_SHIPPING, '', 'SSL') . '">' . zen_image_button(BUTTON_IMAGE_BACK, BUTTON_BACK_ALT) . '</a>';
		}else{
			echo '<a href="' . zen_href_link(FILENAME_ADDRESS_BOOK, '', 'SSL') . '">' . zen_image_button(BUTTON_IMAGE_BACK, BUTTON_BACK_ALT) . '</a>';
		} 
	?>
</div>
