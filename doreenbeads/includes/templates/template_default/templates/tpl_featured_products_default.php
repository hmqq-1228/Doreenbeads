...
<div style="clear:both;">
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td class="navSplitPagesResult_top">
	  	<?php 
			if ($featured_products_split->display_count(TEXT_DISPLAY_NUMBER_OF_PRODUCTS) == ''){
				echo "&nbsp;";
			}
			else{
				echo $featured_products_split->display_count(TEXT_DISPLAY_NUMBER_OF_PRODUCTS);
			}
		?>
	  </td>
  ...
  <?php 
	  if (TEXT_RESULT_PAGE . ' ' . $featured_products_split->display_links(MAX_DISPLAY_PAGE_LINKS, zen_get_all_get_params(array('page', 'info', 'x', 'y', 'main_page'))) == ''){
	  	echo "&nbsp;";
	  }
	  else{
 ...
 */
require($template->get_template_dir('/tpl_modules_products_featured_listing_new.php',DIR_WS_TEMPLATE, $current_page_base,'templates'). '/tpl_modules_products_featured_listing_new.php'); ?>
