...
?>
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"  id="<?php echo 'cat' . $cPath . 'Table'; ?>">
<?php
...
?>
  ...
  <tr>
  <td colspan="<?php echo sizeof($list_box_contents[0]) ?>">
    <?php if($row>0) echo '<div style="text-align:left;" id="'.$page_name . $list_box_contents[$row][1]['product_id'] . '"></div>' ?>
  </td>
</tr>
<?php
  }
