...
function modify_user_photo(){
	...
	news_err+="<div style=''><iframe src='upload_avatar.php' frameborder=0  width=800 scrolling='no'></iframe></div>";
	news_err+="</div>";
...
function checkSearchForm(text){
	...
	if(inputtext == '' || inputtext == text){
		alert('Please enter a keyword or Part No.');
		return false;
	}
	return true;
}
