...
<script type="text/javascript" src="<?php echo $template->get_template_dir('googleanalytics_outgoing.js',DIR_WS_TEMPLATE, $current_page_base,'jscript'). '/googleanalytics_outgoing.js'; ?>"></script>
<?php
} else {
?>
<script type="text/javascript">
