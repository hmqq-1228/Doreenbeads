...
$show_page_array = array('login', 'who_we_are', 'site_map', 'page_not_found', 'club_list');
$show_page_array_right = array('login', 'who_we_are', 'site_map', 'page_not_found', 'promotion', 'non_accessories', 'club_list');
?>
                        ...
                        <div class="contentWrap">
                            ...
                            if (SHOW_BANNERS_GROUP_SET3 != '' && $banner = zen_banner_exists('dynamic', SHOW_BANNERS_GROUP_SET3)) {
                                if ($banner->RecordCount() > 0) {
                                    ?>
                                    <div id="bannerThree"
                                         class="banners"><?php echo zen_display_banner('static', $banner); ?></div>
                                    <?php
                                }
                            }
                            ?>
