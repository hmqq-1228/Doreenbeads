...
define('TEXT_OEM_HEARDER_BANNER','We provide <b>Product Sourcing Service</b>, <b>Custom-Made Service</b>, <b>Repacking and Processing Service</b>, which can meet your special demands.The three services are timely and efficient. Have a try and we believe you will enjoy our services.');
...
define('TEXT_HOW_TO_START_SERVICE_ANSWER', 'If you want to enjoy our repacking service, please feel free to place an order on our website, fill your packing requirement on the <a href="download/Packing list - en.xls" class="fblue">Packing List</a>, and then send it to <a href="mailto:sale@doreenbeads.com" class="fblue">sale@doreenbeads.com</a>. We will prepare your product packing according to your request.<br /><br/>
...
define('TEXT_ADD_ATTACHMENT','Add Attachment');

define('TEXT_SEASONS_OF_SEND_YOU_EMAIL','This email is given to you because you have left an Customized Services on our website. Following is a copy of that information. <br/>');

define('TEXT_WRONG_PRODUCT_NAME','Please enter the Product Name/Link.');
define('TEXT_ENTER_PRODUCT_OF_YOU_WANT','Please enter details of the product you want to buy.');
define('TEXT_EMAIL_REQUIRED','Your email address is required.');
define('TEXT_ENTER_YOUR_NAME','Please enter your name to facilitate our communication.');
?>