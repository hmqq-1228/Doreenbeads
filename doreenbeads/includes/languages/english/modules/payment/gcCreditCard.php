...
//
  ...
  define('MODULE_PAYMENT_GCCREDITCARD_TEXT_HEAD', '<strong>Credit Card (Via Global Collect)</strong>');
...
//					
  define('MODULE_PAYMENT_GCCREDITCARD_TEXT_DESCRIPTION', ' gc credit card');
