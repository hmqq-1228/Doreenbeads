 ...
 */
  ...
  define('MODULE_ORDER_TOTAL_COUPON_TITLE_FIRST', 'New Customer Coupon');
  ...
  define('MODULE_ORDER_TOTAL_COUPON_REDEEM_INSTRUCTIONS', '<p>Dear friend, please type your coupon code (your 3% RCD coupon or 6.01$ New Customer coupon) into the box next to Redemption Code. Your coupon will be applied to the total and reflected in your cart after you click continue.</p>');
  define('MODULE_ORDER_TOTAL_COUPON_USE_NOTE', ''); 
