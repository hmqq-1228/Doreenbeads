...
define('TITLE', 'Kostenloser Versand');
//eof jessa

// Site Tagline
//jessa 2009-08-07 Update the SITE_TAGLINE on meta_tags.php page "the Art of E-commeric"
//define('SITE_TAGLINE', 'The Art of E-commerce')
define('SITE_TAGLINE', 'Pandora Beads Charms passend Großhandel');
//eof jessa

// Custom Keywords
//jessa 2009-08-07 Update the CUSTOM_KEYWORDS on on meta_tags.php page "ecommerce, open source, shop, online shopping"
define('CUSTOM_KEYWORDS', 'Perlen passend zu Pandora Großhandel, Pandora Charms passend Großhandel, Pandora Kette passend Großhandel, Pandora Zubehör passend Großhandel');
//eof jessa

// Home Page Only:
//jessa 2009-08-09
//update define('HOME_PAGE_META_DESCRIPTION', '')
  define('HOME_PAGE_META_DESCRIPTION', 'Versandkostenfrei für alle Produkte und vor allem Großhandel Pandora passende Perlen Charms, Schlangenkette Armband und andere Versorgungsgüter (einschließlich Sicherheitskette, Pandora passende Glasperlen, Pandora passende Charms, Klip, Zwischenperlen).');
//eof jessa
//update define('HOME_PAGE_META_KEYWORDS','')
  define('HOME_PAGE_META_KEYWORDS', 'Großhandel Pandora passende Perlen, Großhandel Pandora passende Charms, Großhandel Pandora passende Kette, Großhandel Pandora passende Zubehör');
//eof jessa
