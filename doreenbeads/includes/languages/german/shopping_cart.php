...
define('TEXT_CART_IS_EMPTY_DO_SHOPPING', 'Ihr Warenkorb ist noch leer. Shoppen Sie jetzt!');
define('TEXT_CART_IS_EMPTY_SHOP','Fangen Sie bitte an!');
define('TEXT_CART_GO_HOMEPAGE', 'Zur Startseite.');
define('TEXT_CART_CONTINUE_SHOPPING', 'Weiter einkaufen');
...
define('TEXT_CART_QUICK_ORDER_BY_CONTENT', 'Sie können die Artikelnr. und Menge eingeben oder Tabelle anfertigen, dann werden die gewünschten Sachen ohne Umwege in den Warenkorb gelegt.');
...
define('TEXT_CART_JS_REMOVE_ITEM', 'Möchten Sie die Artikel entfernen?');
define('TEXT_CART_JS_WRONG_NO', 'Falsche Artikel Nummer');
define('TEXT_CART_JS_NO_STOCK', 'Nicht auf Lager');
...
define('TEXT_CART_VIEW_WISHLIST', 'Wunschliste ansehen');
...
define('TEXT_SHOPPING_CART_COUPON_TIPS', 'Sie können die folgenden Gutscheine verwenden, um den Betrag der Bestellung zu reduzieren, nur wenn der Betrag der Artikel den Mindestbetrag unten erreicht.');
define('TEXT_MY_AVTIVE_COUPONS', 'Meine gültigen Gutscheine');

define('TEXT_BY_SPREADSHEET_TIPS', '1.<a href="'.HTTP_SERVER.'/file/template_spreadsheet.xls"><font color="#06c">Klicken Sie hier</font></a>, um die Kalkulationstabelle herunterzuladen.<br/>
									2.Füllen Sie die Kalkulationstabelle mit Teilenummer und Mengen des Artikels, die Sie brauchen.<br/>
									3.Fügen Sie den Anhang hinzu, dann laden Sie ihn hoch, und die Artikel werden Ihrem Warenkorb erfolgreich hinzugefügt.
								');

define('TEXT_UPLOAD_EXCEL_ERROR_TIPS', 'Akzeptierbares Format: Nur .xlsx, .xls. Eine Datei sollte nicht mehr als 2MB sein.');
