...
define('OTHER_BOX_NOTIFY_REMOVE_ALT', 'Produkt Benachrichtigung entfernen.');
define('OTHER_BOX_NOTIFY_YES_ALT', 'Benachrichtigen Sie mich über Aktuelles zu diesem Artikel.');
define('OTHER_BOX_WRITE_REVIEW_ALT', 'Schreiben Sie eine Bewertung zu diesem Artikel.');
define('OTHER_CALL_FOR_PRICE_ALT', 'Den aktuellen Preis informieren.');
define('OTHER_DOWN_FOR_MAINTENANCE_ALT', 'Die Seite ist derzeit im Wartungsmodus. Bitte versuchen Sie es später wieder.');
