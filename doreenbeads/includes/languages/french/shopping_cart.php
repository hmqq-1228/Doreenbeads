...
define('TEXT_CART_IS_EMPTY_DO_SHOPPING', 'Votre panier est vide, faites des achats tout de suite!');
...
define('TEXT_CART_JS_REMOVE_ITEM', 'Confirmez-vous de supprimer cet articles??');
...
define('TEXT_CART_ADD_WISHLIST_SUCCESS', 'Vous avez ajouter ce produit à vos favoris avec succès!');
define('TEXT_CART_VIEW_WISHLIST', 'Voir mes favoris');
define('TEXT_CART_AVAILABLE_PAYMENT', 'Modes de paiement disponibles');

define('TEXT_SHOPPING_CART_OR', 'ou');
...
define('TEXT_SHOPPING_CART_COUPON_TIPS', 'Vous pouvez utiliser les coupons suivants pour réduire le montant de la commande lorsque le prix de l’article atteint le montant minimum ci-dessous.');
define('TEXT_MY_AVTIVE_COUPONS', 'Mes Coupons Actifs');

define('TEXT_BY_SPREADSHEET_TIPS', '1.<a href="'.HTTP_SERVER.'/file/template_spreadsheet.xls"><font color="#06c">Cliquez ici</font></a> pour télécharger le tableur.<br/>
									2.Remplissez dans le tableur les N° de réf et les quantités d\'articles dont vous avez besoin.<br/>
									3.Ajouter la pièce jointe et la télécharger, et les articles seront ajoutés à votre panier avec succès.
								');

define('TEXT_UPLOAD_EXCEL_ERROR_TIPS', 'Format uniquement acceptez: .xlsx, .xls. Un fichier ne doit pas dépasser 2 MB.');
