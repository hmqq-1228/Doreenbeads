...
//
  ...
  define('MODULE_PAYMENT_GCCREDITCARD_TEXT_HEAD', '<strong>Carte de Crédit (Via Global Collect)</strong>');
...
//					
  define('MODULE_PAYMENT_GCCREDITCARD_TEXT_DESCRIPTION', ' gc Carte de Crédit');
