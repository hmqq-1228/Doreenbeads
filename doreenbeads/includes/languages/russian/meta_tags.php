...
//update define('HOME_PAGE_META_DESCRIPTION', '')
  define('HOME_PAGE_META_DESCRIPTION', 'We offer Free Shipping for all our items and mainly wholesale beads charms fits pandora,snake chain bracelet and other supplies(including safety chain, lampwork glass beads fits pandora, charms fits pandora, clip, spacer beads).');
//eof jessa
//update define('HOME_PAGE_META_KEYWORDS','')
  define('HOME_PAGE_META_KEYWORDS', 'beads ftis pandora wholesale, charms fits pandora wholesale, chain fits pandora wholesale, Supplies fits Pandora Wholesale');
//eof jessa
