...
define('OTHER_BOX_NOTIFY_REMOVE_ALT', 'Удалить это уведомление о продукте.');
define('OTHER_BOX_NOTIFY_YES_ALT', 'Сообщите мне о обновлениях данного товара.');
define('OTHER_BOX_WRITE_REVIEW_ALT', 'Написать отзыв об этом товаре.');
define('OTHER_CALL_FOR_PRICE_ALT', 'Пожалуйста, позвоните для текущей цены.');
define('OTHER_DOWN_FOR_MAINTENANCE_ALT', 'Этот сайт в настоящее время закроется на техническое обслуживание. Пожалуйста, заходите позже.');
define('OTHER_TRANPARENT_ALT', '');
define('OTHER_IMAGE_CUSTOMERS_AUTHORIZATION_ALT', 'УТВЕРЖДЕНИЕ КЛИЕНТА НАХОДИТСЯ В ОЖИДАНИИ ...');
define('OTHER_REVIEWS_RATING_STARS_FIVE_ALT', 'Пять Звёзд');
