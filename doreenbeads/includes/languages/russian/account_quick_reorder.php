...
define('HEADING_ORDER_DATE', 'Дата заказа:');

define('HEADING_ORDER_TOTAL', 'Все заказы:');
...
define('HEADING_ORDER_HISTORY', 'История заказа; Комментарии');
...
//JESSA 2010-03-14
define('HEADING_MODEL', 'Артикул.');
define('HEADING_IMAGE', 'Фото');
//eof jessa 2010-03-14

//jessa 2010-05-10
define('DOWNLOAD_PIC', 'Скачать фото');
