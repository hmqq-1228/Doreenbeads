...
'<font color="green"><hr /><strong>Requirements:</strong></font><br /><hr />*<strong>CURL</strong> is used for bidirectional communication with the gateway, so must be active on your hosting server (if you need to use a CURL proxy, set the CURL proxy settings under Admin->Configuration->My Store.)<br /><hr />' );
  ...
  define('MODULE_PAYMENT_PAYPALWPP_RISK_CUSTOMER', 'Your card does not comply with the risk control policy, the payment failed. Please pay for it in other ways. For more information, please contact Paypal Customer Service or your issuing bank.');
  
  define('MODULE_PAYMENT_PAYPALWPP_PALPAYERID_NULL', 'Express Checkout Payer ID transmission failed, please re-pay.');
  define('MODULE_PAYMENT_PAYPALWPP_NOT_MONEY', 'Your account is underfunded. Please pay for it in other ways. For more information, please contact Paypal Customer Service or your issuing bank.');
  define('MODULE_PAYMENT_PAYPALWPP_NOT_PAYPALMENT', 'Your card has expired/insufficient balance， please change the payment method. For more information, please contact Paypal Customer Service or your issuing bank.');
  define('MODULE_PAYMENT_PAYPALWPP_TOTAL_ZERO', 'Payment failed due to data transfer problem, please re-pay.');
  define('MODULE_PAYMENT_PAYPALWPP_TEXT_ADDR_ERROR_FOR_SHIPPING_ADDRESS', 'Your mailing address information is incorrect. Please check if the country, city, postal code, etc. in your mailing address information match.');
  ...
  define('MODULE_PAYMENT_PAYPALWPP_MARK_BUTTON_TXT', 'Check out securely. <br /><div style="clear:both; padding-bottom:10px;">Pay with Credit Card via PayPal, even if you <strong>do not have a PayPal account</strong>, you can still pay, <a href="https://www.doreenbeads.com/index.php?main_page=page&id=44" alt="https://www.doreenbeads.com/index.php?main_page=page&id=44" target="_blank">click for details>></a></div>');
